...
//    private StartedMockNode seller;
//    private StartedMockNode regulator;
//
//    @Before
//    public void setup() {
...
//        buyer = network.createPartyNode(null);
//        seller = network.createPartyNode(null);
//        regulator = network.createPartyNode(null);
//        // For real nodes this happens automatically, but we have to manually register the flow for tests.
//        for (StartedMockNode node : ImmutableList.of(buyer, seller, regulator)) {
//            node.registerInitiatedFlow(CreateInvoiceFlow.Responder.class);
//        }
//        network.runNetwork();
//    }
//
...
//
//    @Test
//    public void flowCreateInvoice() {
//        // The IOUContract specifies that IOUs cannot have negative values.
//        Party seller = seller.getI
//        CreateInvoiceFlow.Initiator flow = new CreateInvoiceFlow.Initiator(-1, b.getInfo().getLegalIdentities().get(0));
